    ...
    <div className={styles.dashboardContainer}>
      ...
      <div className={styles.dashboardGrid}>
        <div className={styles.card}>
          ...
          <div className={styles.cardContent}>
            ...
            <div className={styles.scanButtonContainer}>
              <Link href="/user-employee/user/scan" className={styles.scanButton}>
                Scan Now
              </Link>
            </div>
          </div>
        ...
        <div className={styles.card}>
          ...
          <Link href="/user-employee/user/profile" className={styles.cardLink}>
            View Full Profile
          </Link>
        </div>
        ...
        <div className={styles.card}>
          ...
          <Link href="/user-employee/user/leaderboard" className={styles.cardLink}>
        ...
        <div className={styles.card}>
          ...
          <Link href="/user-employee/user/rewards" className={styles.cardLink}>
            View All Rewards
          </Link>
        </div>
      </div>
