...
export default function LoginPage() {
  ...
  const handleUserSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push('/user-employee/user/dashboard');
      }, 2000);
  ...
  const handleEmployeeSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (employeeFormData.rememberMe) {
      ...
      // Redirect after showing the notification
      setTimeout(() => {
        router.push('/user-employee/employee/dashboard');
      }, 2000);
                ...
                <form className={styles.form} onSubmit={handleEmployeeSubmit}>
                  ...
                  <div className={styles.rememberMe}>
                    <input
                      ...
                      name="rememberMe"
                      checked={employeeFormData.rememberMe}
                      onChange={handleEmployeeChange}
                      className={styles.checkbox}
                      disabled={loading}
                    />
